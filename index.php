                ...
                <div class="col-lg-5">
                    <div class="service-item">
                        <div class="service-top">
                            ...
                            <p>Deatures ipsum dolor sit ametconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="service-item">
                        <div class="service-top">
                            ...
                            <p>Sharing ipsum dolor sit ametconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                        <div class="service-bottom">
                            <i class='bx bxs-truck'></i>
        ...
        <div class="container">
            ...
            <div class="where-item">
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link-default active" id="pills-home-tab" data-bs-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                            <i class='bx bxs-car'></i>
                            <span>Car <br> Journey</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link-default" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
                            <i class='bx bx-tachometer'></i>
                            <span>Bike <br> Riding</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link-default" id="pills-contact-tab" data-bs-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">
                            <i class='bx bx-cycling'></i>
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <form>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn where-form-btn">Get estimate <i class='bx bx-right-arrow-alt'></i></button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="app-item">
                        ...
                        <p>The procudure ipsum dolor sit ametconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ametconsectetur</p>
                    ...
                    <div class="faq-item">
                        <ul class="accordion">
                            <li>
                                ...
                                <p>Costing ipsum dolor sit ametconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </li>
                            <li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="user-item">
                        ...
                        <p>Very nice dolor sit ametconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div>
                <div class="col-lg-6">
